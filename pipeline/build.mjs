...
// Olkusz: ONE feed, one operator — Związek Komunalny Gmin „Komunikacja Międzygminna” w Olkuszu,
// the union that runs the buses of Olkusz, Bukowno, Bolesław, Klucze and Sławków.
...
const MODES = [{
  mode: 'bus', label: 'buses', osmFile: 'data/osm/olkusz.json',
  graphMode: 'road', color: '#0059a9', colorDark: '#00294f',
  all: busAll, lines: busList.length ? busList : (busAll ? [] : ['457']),
  feeds: [
